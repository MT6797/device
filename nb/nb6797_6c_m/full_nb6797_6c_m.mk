...
$(call inherit-product, device/nb/$(MTK_TARGET_PROJECT)/device.mk)
...
PRODUCT_NAME := full_nb6797_6c_m
PRODUCT_DEVICE := nb6797_6c_m
PRODUCT_MODEL := nb6797_6c_m
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= nb6797_6c_m_debug_defconfig
else
KERNEL_DEFCONFIG ?= nb6797_6c_m_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= nb6797_6c_m
LK_PROJECT ?= nb6797_6c_m
TRUSTY_PROJECT ?= nb6797_6c_m
