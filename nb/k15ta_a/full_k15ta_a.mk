...
PRODUCT_NAME := full_k15ta_a
PRODUCT_DEVICE := k15ta_a
PRODUCT_MODEL := k15ta_a
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k15ta_a_debug_defconfig
else
KERNEL_DEFCONFIG ?= k15ta_a_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k15ta_a
LK_PROJECT ?= k15ta_a
TRUSTY_PROJECT ?= k15ta_a
