...
MTK_REMAKE_ADDED_PROJECT_CONFIG_OPTIONS := $(filter-out $(MTK_REMAKE_PREVIOUS_PROJECT_CONFIG_OPTIONS) BOARD_%_PARTITION_SIZE,$(MTK_REMAKE_CURRENT_PROJECT_CONFIG_OPTIONS))
  endif
