...
MTK_MODEM_REMOVED_MODULES := $(filter-out $(MTK_MODEM_INSTALLED_MODULES),$(wildcard $(TARGET_OUT_ETC)/firmware/modem*.img $(TARGET_OUT_ETC)/firmware/dsp_*.bin $(TARGET_OUT_ETC)/firmware/catcher_filter_*.bin $(TARGET_OUT_ETC)/firmware/em_filter_*.bin $(TARGET_OUT_ETC)/firmware/armv7_*.bin $(TARGET_OUT_ETC)/mddb/*))
.PHONY: update-modem
...
MTK_MODEM_REMOVED_MODULES := $(wildcard $(MTK_MODEM_INSTALLED_MODULES) $(TARGET_OUT_ETC)/firmware/modem*.img $(TARGET_OUT_ETC)/firmware/dsp_*.bin $(TARGET_OUT_ETC)/firmware/catcher_filter_*.bin $(TARGET_OUT_ETC)/firmware/em_filter_*.bin $(TARGET_OUT_ETC)/firmware/armv7_*.bin $(TARGET_OUT_ETC)/mddb/*)
.PHONY: clean-modem
clean-modem:
